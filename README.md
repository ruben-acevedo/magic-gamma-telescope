...
For the complete analysis, please check the jupyter notebook in folder 'scripts'. This is a summary of the analysis.
...
#### 1.4 Number of Instances: 19020

#### 1.5 Number of Attributes: 11 (including the class)

#### 1.6 Attribute information:
...
#### 1.7 Missing Attribute Values: None
